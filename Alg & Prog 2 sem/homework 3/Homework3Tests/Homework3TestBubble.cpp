#include "pch.h"
#include "..//Homework3/Homework3Bubble.cpp"
...
{
    TEST_CLASS(Homework3TestBubble)
    {
    public:
        ...
        TEST_METHOD(TestBubbleSort_1_usual)  // массив с нормальными числами
        {
        ...
        TEST_METHOD(TestBubbleSort_2_negative)  // массив с фулл отрицательными числами
        {
        ...
        TEST_METHOD(TestBubbleSort_3_zero)  // нулевой массивчик
        {
        ...
        TEST_METHOD(TestBubbleSort_4_moreThan100)  // массив с числами > 100
        {
        ...
        TEST_METHOD(TestBubbleSort_5_unoriginal)  // совершенно неоригинальный массив
        {
